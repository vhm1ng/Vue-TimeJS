    ...
    <el-row :gutter="40">
      ...
      <el-col :span="12" class="right">
        <div class="title">
          ...
          <span class="name">Thiết lập Website</span>
        </div>
        <Set />
      </el-col>
    </el-row>
...
const siteUrl = computed(() => {
  ...
  if (!url) return "vhming.com".split(".");
...
const upData = reactive({
  new: [
    "Tái cấu trúc bằng Vue",
    "Danh sách nhạc hỗ trợ tùy chỉnh nhanh chóng",
    "Hình nền hỗ trợ cài đặt được cá nhân hóa",
    "Trình phát nhạc hỗ trợ điều khiển âm lượng",
  ],
  fix: ["Sửa lỗi API thời tiết", "Sửa lỗi hiển thị thời gian", "Sửa lỗi hoạt ảnh và chi tiết trên thiết bị di động", "Biểu tượng được thay đổi thành IconPark"],
});
